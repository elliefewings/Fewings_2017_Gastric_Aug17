...
#Load exac data
exac <- read.table("/scratch/medgen/users/eleanor/2015-16/IHCAP/gast_Aug17/exac_brca2_palb2_vv_20171113.csv", sep = ",", header = TRUE, stringsAsFactors = FALSE)

#Load 1000 genomes data
kgen <- read.table("/scratch/medgen/users/eleanor/2015-16/1kgenomes_analysis/1000genomes_variantfilter_EUR_20170330.csv", sep = ",", header = TRUE, stringsAsFactors = FALSE)
```
